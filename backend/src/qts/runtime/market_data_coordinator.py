...
from qts.runtime.signal_event_writer import RuntimeSignalEventWriter
...
class RuntimeMarketDataCoordinator:
    ...
    def __init__(self, context: object) -> None:
        ...
        self._signal_event_writer = RuntimeSignalEventWriter(self._context)
    ...
    def execute_strategy_bindings(
        ...
        *,
        ...
        for binding in bindings_for_bar:
            ...
            self._signal_event_writer.write_strategy_intent_events(
                binding, strategy_result, correlation_id
            )
    ...
    def process_signal_batch(
        ...
        *,
        ...
        if batch.conflict_reason:
            self._signal_event_writer.write_signal_conflict_events(
                bar,
                batch,
                partition=partition,
                correlation_id=correlation_id,
            )
        self._signal_event_writer.write_signal_aggregated_event(
            bar,
            batch,
            partition=partition,
            correlation_id=correlation_id,
