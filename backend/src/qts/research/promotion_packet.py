...
class PromotionPacketV2:
    ...
    def _append_research_safety_metric_reasons(
        ...
        for field_name in ("deterministic_replay_passed", "no_lookahead_passed"):
            ...
            if value is None:
                reasons.append(
                    f"research.{field_name} is missing: validation artifact not produced"
                )
        ...
        # defaults.
        cls._check_hollow_verdict_sentinel(metrics_payload, reasons)
    ...
    def _check_sharpe_source_provenance(
        ...
        if train_sharpe == oos_sharpe:
            ...
            if train_manifest_hash is not None and oos_manifest_hash is not None:
                ...
                reasons.append(
                    "performance.train_sharpe == oos_sharpe without separate "
