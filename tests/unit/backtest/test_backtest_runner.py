...
def test_load_strategy_loads_from_relative_python_file(monkeypatch, tmp_path: Path) -> None:
...
def test_load_strategy_rejects_non_strategy_class(tmp_path: Path, monkeypatch) -> None:
